/**
 * SAdministracionFaFWS_IAdministracionFaFHttpBindingStub.java
 *
...
public class SAdministracionFaFWS_IAdministracionFaFHttpBindingStub extends org.apache.axis.client.Stub implements mx.com.iusacell.middleware.servicios.gestion.IAdministracionFaF {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("modificarGrupoFaF");
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "miembrosFaF"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://gestion.servicios.middleware.iusacell.com.mx", "GrupoFaF"), mx.com.iusacell.middleware.servicios.gestion.RegistroGrupoFaF[].class, false, false);
        param.setItemQName(new javax.xml.namespace.QName("", "grupoFaF"));
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://mx.com.iusacell.BAdministraFF", "RespuestaFF"));
        oper.setReturnClass(BAdministraFF.iusacell.com.mx.RespuestaFF.class);
    ...
    public SAdministracionFaFWS_IAdministracionFaFHttpBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SAdministracionFaFWS_IAdministracionFaFHttpBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SAdministracionFaFWS_IAdministracionFaFHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://gestion.servicios.middleware.iusacell.com.mx", "GrupoFaF");
            cachedSerQNames.add(qName);
            cls = mx.com.iusacell.middleware.servicios.gestion.RegistroGrupoFaF[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://gestion.servicios.middleware.iusacell.com.mx", "RegistroGrupoFaF");
            qName2 = new javax.xml.namespace.QName("", "grupoFaF");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
            ...
            qName = new javax.xml.namespace.QName("http://mx.com.iusacell.BAdministraFF", "RespuestaFF");
            cachedSerQNames.add(qName);
            cls = BAdministraFF.iusacell.com.mx.RespuestaFF.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public BAdministraFF.iusacell.com.mx.RespuestaFF modificarGrupoFaF(mx.com.iusacell.comun.Usuario usuario, mx.com.iusacell.comun.Linea linea, mx.com.iusacell.middleware.servicios.gestion.RegistroGrupoFaF[] miembrosFaF) throws java.rmi.RemoteException, mx.com.iusacell.comun.Falta {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://gestion.servicios.middleware.iusacell.com.mx", "modificarGrupoFaF"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {usuario, linea, miembrosFaF});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (BAdministraFF.iusacell.com.mx.RespuestaFF) _resp;
            } catch (java.lang.Exception _exception) {
                return (BAdministraFF.iusacell.com.mx.RespuestaFF) org.apache.axis.utils.JavaUtils.convert(_resp, BAdministraFF.iusacell.com.mx.RespuestaFF.class);
            }
        }
