...
public class CallObtieneCaes {
	
			@SuppressWarnings("static-access")
			public String callObtieneListaVersionCaeS(final int canal,final int idAplicacion) throws ServiceException {
				...
				try
				{
				    generaToken = GeneraToken.generaToken(idAplicacion+"");
				    
				    try{
						CallObtieneCaes cifrado = new CallObtieneCaes();
					...
					sXMLRequest.append(        "<ser:MapaGetCae>");
